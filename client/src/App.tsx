/** Community Wayfinding: global route shell makes screening, history, and analytics visible across the complete product journey. */
import "./screens.css";
...
function RoutedApplication({ language }: { language: Language }) { return <Switch><Route path="/">{() => <Home language={language} />}</Route><Route path="/patient" component={PatientDashboard} /><Route path="/history" component={PatientHistory} /><Route path="/analytics" component={AnalyticsDashboard} /><Route path="/doctor" component={DoctorDashboard} /><Route path="/how-it-works" component={HowItWorks} /><Route path="/about" component={About} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
